...
@Tag("unit")
public class VolumeFileManagerParamTest {
    ...
    void testBuildWithAllOptions() {
        VolumeFileManagerParam param = VolumeFileManagerParam.newBuilder()
                ...
                .withConnectType(ConnectType.INTERNAL)
                .build();
        ...
        assertEquals(ConnectType.INTERNAL, param.getConnectType());
        assertTrue(param.toString().contains("volume-1"));
    }

    @Test
    void testBuildDefaultConnectType() {
        VolumeFileManagerParam param = VolumeFileManagerParam.newBuilder()
                .withCloudEndpoint("https://api.cloud.zilliz.com")
                .withApiKey("api-key")
                .withVolumeName("volume-1")
    ...
    void testBuildRejectsMissingRequiredFields() {
        assertThrows(ParamException.class, () -> VolumeFileManagerParam.newBuilder()
                .withApiKey("api-key")
                .withVolumeName("volume-1")
                .build());
        assertThrows(ParamException.class, () -> VolumeFileManagerParam.newBuilder()
