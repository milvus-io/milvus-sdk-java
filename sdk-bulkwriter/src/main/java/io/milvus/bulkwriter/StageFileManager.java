...
public class StageFileManager {
    ...
    private String uploadLocalFileToStage(String localFilePath, String rootPath, String stagePath) {
        File file = new File(localFilePath);
        ...
        putObjectWithRetry(file, remoteFilePath);
        return remoteFilePath;
    }

    private void putObjectWithRetry(File file, String remoteFilePath) {
        refreshIfExpire();
    ...
    private <T> T withRetry(String actionName, Callable<T> callable) {
    ...
    private void withRetry(String actionName, Runnable runnable) {
