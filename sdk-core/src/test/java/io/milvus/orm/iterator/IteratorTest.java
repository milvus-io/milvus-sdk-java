...
class IteratorTest {
    ...
    private static QueryResults elementQueryResults(long id, long offset) {
        return QueryResults.newBuilder()
                .setStatus(successStatus())
                .setSessionTs(100L)
                .addOutputFields("id")
                .addOutputFields(Constant.OFFSET)
                .addFieldsData(FieldData.newBuilder()
                        .setFieldName("id")
                        .setType(DataType.Int64)
                        .setScalars(ScalarField.newBuilder()
                        ...
                        .build())
                .addFieldsData(FieldData.newBuilder()
                        .setFieldName(Constant.OFFSET)
                        .setType(DataType.Int64)
                        .setScalars(ScalarField.newBuilder()
                                .setLongData(LongArray.newBuilder().addData(offset).build())
                                .build())
                        .build())
                .build();
    }
