...
class ListSnapshotsReqTest {
    ...
    void unsetFieldsDefaultToEmptyString() {
        ListSnapshotsReq request = ListSnapshotsReq.builder().build();
    ...
    void toStringContainsFields() {
        ...
        assertEquals("ListSnapshotsReq{databaseName='db', collectionName='coll'}", text);
    }
}
