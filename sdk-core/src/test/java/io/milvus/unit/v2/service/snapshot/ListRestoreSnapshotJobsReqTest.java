...
@Tag("unit")
class ListRestoreSnapshotJobsReqTest {
    @Test
    ...
    @Test
    void unsetFieldsDefaultToEmptyString() {
        ListRestoreSnapshotJobsReq request = ListRestoreSnapshotJobsReq.builder().build();
    ...
    void toStringContainsFields() {
        ...
        assertEquals("ListRestoreSnapshotJobsReq{databaseName='db', collectionName='coll'}", text);
    }
}
