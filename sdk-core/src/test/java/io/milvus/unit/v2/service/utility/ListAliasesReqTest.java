...
@Tag("unit")
class ListAliasesReqTest {
    @Test
    void builderBuildsAllFields() {
        ListAliasesReq request = ListAliasesReq.builder()
                .databaseName("db")
                .collectionName("coll")
                .build();
    ...
    void unsetFieldsDefaultToNull() {
        ListAliasesReq request = ListAliasesReq.builder().build();
    ...
    void toStringContainsFields() {
        ...
        assertEquals("ListAliasesReq{databaseName='db', collectionName='coll'}", text);
    }
}
