...
@Tag("unit")
class GetPartitionStatsReqTest {
    @Test
    ...
    void unsetFieldsDefaultToNull() {
        GetPartitionStatsReq request = GetPartitionStatsReq.builder().build();
    ...
    void toStringContainsFields() {
        ...
        assertEquals("GetPartitionStatsReq{databaseName='db', collectionName='coll', partitionName='part'}",
                request.toString());
    }
}
