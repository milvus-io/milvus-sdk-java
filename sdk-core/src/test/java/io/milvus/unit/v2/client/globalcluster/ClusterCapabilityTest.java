...
class ClusterCapabilityTest {
    ...
    @Test
    void bitFlagsMatchDocumentation() {
    ...
    @Test
    void primaryIsReadablePlusWritable() {
        assertEquals(ClusterCapability.READABLE | ClusterCapability.WRITABLE,
                ClusterCapability.PRIMARY);
    }
}
