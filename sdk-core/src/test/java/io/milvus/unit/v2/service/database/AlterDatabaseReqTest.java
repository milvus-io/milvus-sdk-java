...
@Tag("unit")
class AlterDatabaseReqTest {

    @Test
    void builderBuildsWithAllFields() {
        Map<String, String> properties = new HashMap<>();
        properties.put("database.replica", "3");
        AlterDatabaseReq request = AlterDatabaseReq.builder()
                .databaseName("db")
    ...
    void settersUpdateGetters() {
        AlterDatabaseReq request = AlterDatabaseReq.builder().build();
    ...
    void propertiesDefaultToEmptyMap() {
        AlterDatabaseReq request = AlterDatabaseReq.builder().databaseName("db").build();
