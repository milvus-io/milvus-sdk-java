...
@Tag("unit")
class GetCompactionPlansReqTest {
    @Test
    void builderBuildsAllFields() {
        GetCompactionPlansReq request = GetCompactionPlansReq.builder()
                .compactionID(123L)
                .build();
    ...
    void unsetFieldDefaultsToNull() {
        GetCompactionPlansReq request = GetCompactionPlansReq.builder().build();
    ...
    void toStringContainsFields() {
        ...
        assertEquals("GetCompactionPlansReq{compactionID=1}", text);
    }
}
