...
class DropPartitionReqTest {
    ...
    void unsetFieldsDefaultToNull() {
        DropPartitionReq request = DropPartitionReq.builder().build();
    ...
    void toStringContainsFields() {
        ...
        assertEquals("DropPartitionReq{databaseName='db', collectionName='coll', partitionName='part'}",
                request.toString());
    }
}
