...
class CreateDatabaseReqTest {
    ...
    void settersUpdateGetters() {
        CreateDatabaseReq request = CreateDatabaseReq.builder().build();
        ...
        assertSame(props, request.getProperties());
    }

    @Test
    void propertiesDefaultToEmptyMap() {
        CreateDatabaseReq request = CreateDatabaseReq.builder().databaseName("db").build();
    ...
    void builderFactoryReturnsBuilder() {
        assertNotNull(CreateDatabaseReq.builder());
        assertNotNull(CreateDatabaseReq.builder().databaseName("db").build());
    }
