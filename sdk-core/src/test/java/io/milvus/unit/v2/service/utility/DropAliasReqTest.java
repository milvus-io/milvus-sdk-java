...
@Tag("unit")
class DropAliasReqTest {
    @Test
    void builderBuildsAllFields() {
        DropAliasReq request = DropAliasReq.builder()
                .databaseName("db")
                .alias("alias")
                .build();
    ...
    void unsetFieldsDefaultToNull() {
        DropAliasReq request = DropAliasReq.builder().build();
    ...
    void toStringContainsFields() {
        ...
        assertEquals("DropAliasReq{databaseName='db', alias='alias'}", text);
    }
}
