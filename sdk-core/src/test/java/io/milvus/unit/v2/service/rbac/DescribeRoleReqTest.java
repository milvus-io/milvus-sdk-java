...
@Tag("unit")
class DescribeRoleReqTest {
    @Test
    void builderBuildsAllFields() {
        DescribeRoleReq request = DescribeRoleReq.builder()
                .roleName("readonly")
                .dbName("default")
                .build();
    ...
    void unsetFieldsDefaultToNull() {
        DescribeRoleReq request = DescribeRoleReq.builder().build();
    ...
    void toStringContainsFields() {
        ...
        assertEquals("DescribeRoleReq{roleName='readonly', dbName='default'}", request.toString());
    }
}
