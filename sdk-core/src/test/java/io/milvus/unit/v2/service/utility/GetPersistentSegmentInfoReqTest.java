...
@Tag("unit")
class GetPersistentSegmentInfoReqTest {
    @Test
    void builderBuildsAllFields() {
        GetPersistentSegmentInfoReq request = GetPersistentSegmentInfoReq.builder()
                .databaseName("db")
                .collectionName("coll")
                .build();
    ...
    void unsetFieldsDefaultToNull() {
        GetPersistentSegmentInfoReq request = GetPersistentSegmentInfoReq.builder().build();
    ...
    void toStringContainsFields() {
        ...
        assertEquals("GetPersistentSegmentInfoReq{databaseName='db', collectionName='coll'}", text);
    }
}
