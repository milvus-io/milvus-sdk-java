...
class GrantPrivilegeReqTest {
    ...
    void unsetFieldsDefaultToNull() {
        GrantPrivilegeReq request = GrantPrivilegeReq.builder().build();
    ...
    void toStringContainsFields() {
        ...
        assertEquals("GrantPrivilegeReq{roleName='role', dbName='db', objectType='Collection', privilege='Search', objectName='coll'}",
                request.toString());
    }
}
