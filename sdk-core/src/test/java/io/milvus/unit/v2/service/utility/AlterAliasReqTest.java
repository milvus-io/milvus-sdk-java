...
@Tag("unit")
class AlterAliasReqTest {
    @Test
    void builderBuildsAllFields() {
        AlterAliasReq request = AlterAliasReq.builder()
                .databaseName("db")
                .collectionName("coll")
                .alias("alias")
                .build();
    ...
    void unsetFieldsDefaultToNull() {
        AlterAliasReq request = AlterAliasReq.builder().build();
    ...
    void toStringContainsFields() {
        ...
        assertEquals("AlterAliasReq{databaseName='db', collectionName='coll', alias='alias'}", text);
    }
}
