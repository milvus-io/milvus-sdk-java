...
class GrantPrivilegeReqV2Test {
    ...
    void unsetFieldsDefaultToNull() {
        GrantPrivilegeReqV2 request = GrantPrivilegeReqV2.builder().build();
    ...
    void toStringContainsFields() {
        ...
        assertEquals("GrantPrivilegeReqV2{roleName='role', privilege='Search', dbName='db', collectionName='coll'}",
                request.toString());
    }
}
