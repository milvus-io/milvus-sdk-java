...
class HasPartitionReqTest {
    ...
    void unsetFieldsDefaultToNull() {
        HasPartitionReq request = HasPartitionReq.builder().build();
    ...
    void toStringContainsFields() {
        ...
        assertEquals("HasPartitionReq{databaseName='db', collectionName='coll', partitionName='part'}",
                request.toString());
    }
}
