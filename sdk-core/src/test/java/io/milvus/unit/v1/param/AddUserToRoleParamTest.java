...
@Tag("unit")
class AddUserToRoleParamTest {
    @Test
    void buildAndGet() {
        AddUserToRoleParam param = AddUserToRoleParam.newBuilder()
                .withUserName("user1")
                .withRoleName("role1")
                .build();
    ...
    void buildFailsWhenUserNameMissing() {
        assertThrows(ParamException.class, () -> AddUserToRoleParam.newBuilder()
                .withRoleName("role1")
                .build());
        assertThrows(ParamException.class, () -> AddUserToRoleParam.newBuilder()
                .withUserName("")
    ...
    void withUserNameRejectsNull() {
        assertThrows(IllegalArgumentException.class, () ->
                AddUserToRoleParam.newBuilder().withUserName(null));
    }

    @Test
    void withRoleNameRejectsNull() {
        assertThrows(IllegalArgumentException.class, () ->
                AddUserToRoleParam.newBuilder().withRoleName(null));
    }
}
