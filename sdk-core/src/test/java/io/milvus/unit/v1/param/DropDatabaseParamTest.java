...
class DropDatabaseParamTest {
    ...
    void nullDatabaseNameIsRejected() {
        assertThrows(IllegalArgumentException.class,
                () -> DropDatabaseParam.newBuilder().withDatabaseName(null));
    }

    @Test
    void emptyDatabaseNameIsRejectedByBuild() {
        assertThrows(ParamException.class,
                () -> DropDatabaseParam.newBuilder().withDatabaseName("").build());
    }

    @Test
    void missingDatabaseNameIsRejectedByBuild() {
        assertThrows(ParamException.class, () -> DropDatabaseParam.newBuilder().build());
    }

    @Test
    void blankDatabaseNameIsRejectedByBuild() {
        assertThrows(ParamException.class,
                () -> DropDatabaseParam.newBuilder().withDatabaseName("   ").build());
    }
}
