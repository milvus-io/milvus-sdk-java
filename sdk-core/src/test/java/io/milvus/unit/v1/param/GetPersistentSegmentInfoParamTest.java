...
@Tag("unit")
class GetPersistentSegmentInfoParamTest {
    @Test
    void buildAndGet() {
    ...
    void buildFailsWhenCollectionNameMissing() {
        assertThrows(ParamException.class, () -> GetPersistentSegmentInfoParam.newBuilder().build());
    }

    @Test
    void withCollectionNameRejectsNull() {
        assertThrows(IllegalArgumentException.class, () ->
                GetPersistentSegmentInfoParam.newBuilder().withCollectionName(null));
    }
}
