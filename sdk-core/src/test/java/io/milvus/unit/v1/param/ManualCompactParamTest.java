...
class ManualCompactParamTest {
    ...
    void buildFailsWhenCollectionNameMissing() {
        assertThrows(ParamException.class, () -> ManualCompactParam.newBuilder().build());
    }

    @Test
    void withCollectionNameRejectsNull() {
        assertThrows(IllegalArgumentException.class, () ->
                ManualCompactParam.newBuilder().withCollectionName(null));
    }
}
