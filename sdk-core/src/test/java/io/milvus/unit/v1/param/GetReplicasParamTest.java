...
class GetReplicasParamTest {
    ...
    @Test
    void withShardNodesAlwaysTrue() {
        GetReplicasParam param = GetReplicasParam.newBuilder()
                .withCollectionName("coll1")
                .build();

        assertTrue(param.isWithShardNodes());
    }

    @Test
    void buildFailsWhenCollectionNameMissing() {
        assertThrows(ParamException.class, () -> GetReplicasParam.newBuilder().build());
    }

    @Test
    void withMethodsRejectNull() {
        assertThrows(IllegalArgumentException.class, () ->
                GetReplicasParam.newBuilder().withDatabaseName(null));
        assertThrows(IllegalArgumentException.class, () ->
                GetReplicasParam.newBuilder().withCollectionName(null));
    }
}
