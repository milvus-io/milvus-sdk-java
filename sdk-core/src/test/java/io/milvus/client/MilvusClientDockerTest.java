...
//                System.out.println(record);
    ...
    void testCacheCollectionSchema() throws InterruptedException {
        ...
        long ts11 = CollectionTsCache.getInstance().get(milvus.getEndpoint(), "default", randomCollectionName);
        ...
        long ts12 = CollectionTsCache.getInstance().get(milvus.getEndpoint(), "default", randomCollectionName);
        ...
        long ts21 = CollectionTsCache.getInstance().get(milvus.getEndpoint(), testDbName, randomCollectionName);
        ...
        // check the timestamp of this collection, must be positive
        long ts22 = CollectionTsCache.getInstance().get(milvus.getEndpoint(), testDbName, randomCollectionName);
        ...
        long ts23 = CollectionTsCache.getInstance().get(milvus.getEndpoint(), testDbName, randomCollectionName);
        ...
        long ts31 = CollectionTsCache.getInstance().get(milvus.getEndpoint(), testDbName, randomCollectionName);
        ...
        // check the timestamp of this collection, must be null
        long ts32 = CollectionTsCache.getInstance().get(milvus.getEndpoint(), testDbName, randomCollectionName);
