...
public class BulkWriterStageExample {
    ...
    private static void exampleAllTypesCollectionRemote(List<BulkFileType> fileTypes) throws Exception {
        ...
        for (BulkFileType fileType : fileTypes) {
            ...
            StageUploadResult stageUploadResult = allTypesRemoteWriter(collectionSchema, fileType, rows);
    ...
    private static void callStageImport(String stageName, String path) {
        List<String> importDataPath = Lists.newArrayList(path);
        StageImportRequest request = StageImportRequest.builder()
                .apiKey(API_KEY)
                ...
                .build();
        String bulkImportResult = BulkImportUtils.bulkImport(CLOUD_ENDPOINT, request);
    ...
    private static StageUploadResult allTypesRemoteWriter(CreateCollectionReq.CollectionSchema collectionSchema,
